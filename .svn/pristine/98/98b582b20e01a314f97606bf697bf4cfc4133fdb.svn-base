...
<link rel="stylesheet" href="<%=request.getContextPath()%>/statics/css/style_1.css">
<script src="<%=request.getContextPath()%>/statics/js/jquery-1.12.4.js"></script>
<script src="<%=request.getContextPath()%>/statics/js/code.js"></script>
<body>
	<!-- Page Loader    -->
      <div class="spinner">
    ...
    <div class="navigation">
        <ul>
            <li><a href="<%=request.getContextPath() %>/admin/index.jsp">返回首页</a></li>
            <li><a href="<%=request.getContextPath() %>/login.jsp">登录页面</a></li>
			<li><a href="javascript:void(0)" onclick="windowClose()">关闭</a></li>
        </ul>
    </div>
     
 
   <section class="error">
       <h1 style="color:black">哎呀，页面出错了！</h1>
       <p style="color:black">为什么不试试下面的链接?</p>
   </section>
  ...
  <div id="svg_container">      
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
       ...
       <!-- SVG of Submarine ends     -->
        ...
        <!-- SVG of Water waves   -->
       <div id="waves" width="2000" viewBox="0 0 1366 768">
           <g>
