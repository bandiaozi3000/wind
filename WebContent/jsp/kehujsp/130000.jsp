...
padding-top:30px;
 ...
 <!--河北省  -->
 <script>
        var url = "<%=request.getContextPath()%>/agent/listAgent.do?furl=kehujsp/330000&province=130000&city=";
        var dataStatus = [
            { id: 'CN-01', code: '130800', name: '承德市', event: '1', url: url, lx: "300px", ly: "80px" },
            { id: 'CN-02', code: '130700', name: '张家口市', event: '1', url: url, lx: "190px", ly: "180px" },
            { id: 'CN-03', code: '130600', name: '保定市', event: '1', url: url, lx: "260px", ly: "290px" },
            { id: 'CN-04', code: '130300', name: '秦皇岛市', event: '1', url: url, lx: "395px", ly: "100px" },
            { id: 'CN-05', code: '130200', name: '唐山市', event: '1', url: url, lx: "380px", ly: "150px" },
            { id: 'CN-07', code: '130100', name: '石家庄市', event: '1', url: url, lx: "260px", ly: "360px" },
            { id: 'CN-08', code: '130500', name: '邢台市', event: '1', url: url, lx: "320px", ly: "400px" },
            { id: 'CN-09', code: '130400', name: '邯郸市', event: '1', url: url, lx: "320px", ly: "460px" },
            { id: 'CN-10', code: '131100', name: '衡水市', event: '1', url: url, lx: "345px", ly: "345px" },
			{ id: 'CN-11', code: '130900', name: '沧州市', event: '1', url: url, lx: "380px", ly: "280px" },
			{ id: 'CN-12', code: '131000', name: '廊坊市', event: '1', url: url, lx: "320px", ly: "240px" }
        ...
        {
            $( "#city" ).val( cityData );
            window.parent.ListByArea2( 130000, cityData )
        }
        $(function () {
            var palette = ['#1eafff'];
            ...
            map = new jvm.WorldMap({
                ...
                onRegionClick: function (event, code) {
                    $.each(dataStatus, function (i, items) {
                        ...
                        {
                            //子类iframe内调用父类函数：
                            window.parent.LoadDataByArea( "130000", items.code );
                            $( "#city" ).val( items.code );
                        }
                    });
                }
            ...
            $.each(dataStatus, function (i, items) {
                var html = "<div id=\"" + items.id + "\" class=\"jvectormap-label\" onclick=\"Setcity( " + 130000 + ", " + items.code + " )\" style=\"display: block; left: " + items.lx + "; top: " + items.ly + "; color:#fff\">" + items.name + "</div>";
                $("#map1").append(html);
            });
            $.each(dataStatus, function (i, items) {
                $("#map1>div").each(function () {
                    ...
                    if (id == items.id) {
                        ...
                        /*页面跳转路径  */$(this).attr("onclick", "top.location.href = '" + items.url + "'");
...
<div class="about_right1" id="about_right1">
	...
	<!-- 展示索引 -->
	<div class="quick_navigation">
			<h1 style="font-size:20px;color:#1eafff"><a href="<%=request.getContextPath()%>/jsp/kehujsp/quanguo.jsp" style="color:#1eafff">中国</a>&nbsp;· &nbsp;<a href="" style="color:#1eafff">河北!</a></h1>
	</div>
			...
			<div class="contentDiv_xin">
				...
				<form id="fromcha" action="<%=request.getContextPath() %>/agent/solrAgent.do" method="post">
							...
							<input type="hidden" name="furl" value="kehujsp/310000">
				...
				<!-- 地图 -->
				 <div id="map1" class="customProvince">
			  	 <input type="hidden" id="city" />
			   	 <input type="hidden" id="province" value="130000" />
			   
			    </div>
			    
			    <script src="<%=request.getContextPath()%>/statics/js/jquery.vmap.js"></script>
			    <script src="<%=request.getContextPath()%>/statics/js/hebei.js"></script>
