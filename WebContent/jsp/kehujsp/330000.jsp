...
<script>
        var url = "<%=request.getContextPath()%>/agent/listAgent.do?furl=kehujsp/330000&province=330000&city=";
        var dataStatus = [
            { id: 'CN-01', name: '湖州市', code: '330500', event: '1', url: url, lx: "245px", ly: "50px" },
            { id: 'CN-02', name: '嘉兴市', code: '330400', event: '1', url: url, lx: "330px", ly: "60px" },
            { id: 'CN-03', name: '杭州市', code: '330100', event: '1', url: url, lx: "200px", ly: "160px" },
            { id: 'CN-04', name: '衢州市', code: '330800', event: '1', url: url, lx: "140px", ly: "285px" },
            { id: 'CN-05', name: '丽水市', code: '331100', event: '1', url: url, lx: "240px", ly: "360px" },
            { id: 'CN-06', name: '温州市', code: '330300', event: '1', url: url, lx: "320px", ly: "420px" },
            { id: 'CN-07', name: '台州市', code: '331000', event: '1', url: url, lx: "380px", ly: "280px" },
            { id: 'CN-08', name: '金华市', code: '330700', event: '1', url: url, lx: "260px", ly: "250px" },
            { id: 'CN-09', name: '绍兴市', code: '330600', event: '1', url: url, lx: "330px", ly: "170px" },
            { id: 'CN-10', name: '宁波市', code: '330200', event: '1', url: url, lx: "425px", ly: "160px" },
			{ id: 'CN-11', name: '舟山市', code: '330900', event: '1', url: url, lx: "390px", ly: "85px" }
        ];
        var map;
        var regionhits = {};
        ...
        {
            $( "#city" ).val( cityData );
            window.parent.ListByArea2( 330000, cityData )
        }
        $(function () {
            var palette = ['#1eafff'];
            ...
            map = new jvm.WorldMap({
                ...
                onRegionClick: function (event, code) {
                    $.each(dataStatus, function (i, items) {
                        if (code == items.id) {
                            window.parent.LoadDataByArea( "330000", items.code );
                            $( "#city" ).val( items.code );
                        }
                    });
                }
            ...
            $.each(dataStatus, function (i, items) {
                var html = "<div id=\"" + items.id + "\" class=\"jvectormap-label\" onclick=\"Setcity( " + 330000 + ", " + items.code + " )\" style=\"display: block; left: " + items.lx + "; top: " + items.ly + "; color:#fff\">" + items.name + "</div>";
                $("#map1").append(html);
            });
            $.each(dataStatus, function (i, items) {
...
<div class="about_right1" id="about_right1">
	...
	<!-- 展示索引 -->
	<div class="quick_navigation">
			<h1 style="font-size:20px;color:#1eafff"><a href="<%=request.getContextPath()%>/jsp/kehujsp/quanguo.jsp" style="color:#1eafff">中国</a>&nbsp;· &nbsp;<a href="" style="color:#1eafff">浙江!</a></h1>
	</div>
			...
			<div class="contentDiv_xin">
				...
				<form id="fromcha" action="<%=request.getContextPath() %>/agent/solrAgent.do" method="post">
							...
							<input type="hidden" name="furl" value="kehujsp/330000">
				 ...
				 <div id="map1" class="customProvince">
				    ...
				    <input type="hidden" id="province" value="330000" />
				    </div>
				   
				    <script src="<%=request.getContextPath() %>/statics/js/jquery.vmap.js"></script>
				    <script src="<%=request.getContextPath() %>/statics/js/zhejiang.js"></script>
