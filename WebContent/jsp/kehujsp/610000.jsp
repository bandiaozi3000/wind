...
<script>
        ...
        var url = "<%=request.getContextPath()%>/agent/listAgent.do?furl=kehujsp/610000&province=610000&city=";
        var dataStatus = [
            { id: 'CN-01', code: '610800', name: '榆林市', event: '1', url: url, lx: "350px", ly: "85px" },
            { id: 'CN-02', code: '610600', name: '延安市', event: '1', url: url, lx: "340px", ly: "200px" },
            { id: 'CN-03', code: '610500', name: '渭南市', event: '1', url: url, lx: "360px", ly: "290px" },
            { id: 'CN-04', code: '610200', name: '铜川市', event: '1', url: url, lx: "320px", ly: "270px" },
            { id: 'CN-05', code: '610400', name: '咸阳市', event: '1', url: url, lx: "290px", ly: "300px" },
            { id: 'CN-06', code: '610300', name: '宝鸡市', event: '1', url: url, lx: "240px", ly: "330px" },
            { id: 'CN-07', code: '610100', name: '西安市', event: '1', url: url, lx: "310px", ly: "345px" },
            { id: 'CN-08', code: '611000', name: '商洛市', event: '1', url: url, lx: "370px", ly: "370px" },
            { id: 'CN-09', code: '610700', name: '汉中市', event: '1', url: url, lx: "230px", ly: "400px" },
            { id: 'CN-10', code: '610900', name: '安康市', event: '1', url: url, lx: "320px", ly: "430px" }
        ];
        var map;
        var regionhits = {};
        ...
        {
            $( "#city" ).val( cityData );
            window.parent.ListByArea2( 610000, cityData )
        }
        $(function () {
            var palette = ['#1eafff'];
            ...
            map = new jvm.WorldMap({
                ...
                onRegionClick: function (event, code) {
                    $.each(dataStatus, function (i, items) {
                        if (code == items.id) {
                            //子类iframe内调用父类函数：
                            window.parent.LoadDataByArea( "610000", items.code );
                            $( "#city" ).val( items.code );
                        }
                    });
                }
            ...
            $.each(dataStatus, function (i, items) {
                var html = "<div id=\"" + items.id + "\" class=\"jvectormap-label\" onclick=\"Setcity( " + 610000 + ", " + items.code + " )\" style=\"display: block; left: " + items.lx + "; top: " + items.ly + "; color:#fff\">" + items.name + "</div>";
                $("#map1").append(html);
            });
            $.each(dataStatus, function (i, items) {
...
<div class="about_right1" id="about_right1">
	...
	<!-- 展示索引 -->
	<div class="quick_navigation">
			<h1 style="font-size:20px;color:#1eafff"><a href="<%=request.getContextPath()%>/jsp/kehujsp/quanguo.jsp" style="color:#1eafff">中国</a>&nbsp;· &nbsp;<a href="" style="color:#1eafff">陕西!</a></h1>
	</div>
			...
			<div class="contentDiv_xin">
				...
				<form id="fromcha" action="<%=request.getContextPath() %>/agent/solrAgent.do" method="post">
							...
							<input type="hidden" name="furl" value="kehujsp/610000">
				 ...
				 <div id="map1" class="customProvince">
				    ...
				    <input type="hidden" id="province" value="610000" />
				    </div>
				   
				    <script src="<%=request.getContextPath() %>/statics/js/jquery.vmap.js"></script>
				    <script src="<%=request.getContextPath() %>/statics/js/shanxi.js"></script>
