...
padding-top:30px;
 ...
 <script>
        ...
        var url = "<%=request.getContextPath()%>/agent/listAgent.do?furl=kehujsp/410000&province=410000&city=";
        var dataStatus = [
             { id: 'CN-01', name: '安阳市', code: '410500', event: '1', url: url, lx: "360px", ly: "40px" },
            { id: 'CN-02', name: '濮阳市', code: '410900', event: '1', url: url, lx: "410px", ly: "70px" },
            { id: 'CN-03', name: '鹤壁市', code: '410600', event: '1', url: url, lx: "340px", ly: "70px" },
            { id: 'CN-04', name: '新乡市', code: '410700', event: '1', url: url, lx: "330px", ly: "120px" },
            { id: 'CN-05', name: '焦作市', code: '410800', event: '1', url: url, lx: "250px", ly: "130px" },
            { id: 'CN-06', name: '郑州市', code: '410100', event: '1', url: url, lx: "300px", ly: "170px" },
            { id: 'CN-07', name: '开封市', code: '410200', event: '1', url: url, lx: "360px", ly: "170px" },
            { id: 'CN-08', name: '商丘市', code: '411400', event: '1', url: url, lx: "460px", ly: "200px" },
            { id: 'CN-09', name: '周口市', code: '411600', event: '1', url: url, lx: "400px", ly: "260px" },
            { id: 'CN-10', name: '驻马店市', code: '411700', event: '1', url: url, lx: "330px", ly: "330px" },
			{ id: 'CN-11', name: '信阳市', code: '411500', event: '1', url: url, lx: "400px", ly: "420px" },
			{ id: 'CN-12', name: '南阳市', code: '411300', event: '1', url: url, lx: "180px", ly: "340px" },
			{ id: 'CN-13', name: '平顶山市', code: '410400', event: '1', url: url, lx: "230px", ly: "250px" },
            { id: 'CN-14', name: '许昌市', code: '411000', event: '1', url: url, lx: "300px", ly: "230px" },
            { id: 'CN-15', name: '漯河市', code: '411100', event: '1', url: url, lx: "320px", ly: "270px" },
            { id: 'CN-16', name: '洛阳市', code: '410300', event: '1', url: url, lx: "170px", ly: "220px" },
            { id: 'CN-17', name: '三门峡市', code: '411200', event: '1', url: url, lx: "90px", ly: "200px" },
            { id: 'CN-18', name: '济源市', code: '1000742', event: '1', url: url, lx: "200px", ly: "130px" }
        ];
        var map;
        var regionhits = {};
        ...
        {
            $( "#city" ).val( cityData );
            window.parent.ListByArea2( 410000, cityData ) 
        ...
        $(function () {
            ...
            map = new jvm.WorldMap({
                ...
                onRegionClick: function (event, code) {
                    $.each(dataStatus, function (i, items) {
                        if (code == items.id) {
                            //子类iframe内调用父类函数：
                           window.parent.LoadDataByArea( "410000", items.code );
          ...
          $.each(dataStatus, function (i, items) {
                var html = "<div id=\"" + items.id + "\" class=\"jvectormap-label\" onclick=\"Setcity( " + 410000 + ", " + items.code + " )\" style=\"display: block; left: " + items.lx + "; top: " + items.ly + "; color:#fff\">" + items.name + "</div>";
                $("#map1").append(html);
            }); 
            $.each(dataStatus, function (i, items) {
                $("#map1>div").each(function () {
                    ...
                    if (id == items.id) {
                       ...
                       /*跳转路径  */ $(this).attr("onclick", "top.location.href = '" + items.url + items.code + "'");
...
<div class="about_right1" id="about_right1">
	...
	<div class="quick_navigation">
			<h1 style="font-size:20px;color:#1eafff"><a href="<%=request.getContextPath()%>/jsp/kehujsp/quanguo.jsp" style="color:#1eafff">中国</a>&nbsp;· &nbsp;<a href="" style="color:#1eafff">河南!</a></h1>
			</div>
			<div class="contentDiv_xin">
				...
				<div style="clear:both">
							...
							<input type="hidden" name="furl" value="kehujsp/410000">
			    ...
			    <input type="hidden" id="province" value="410000" />
    			</div>
			   
			    <script src="<%=request.getContextPath()%>/statics/js/jquery.vmap.js"></script>
			    <script src="<%=request.getContextPath()%>/statics/js/henan.js"></script>
