...
<body>
	...
	<div id="warehouse"
		...
		<div class="input"
			...
			<input type="text" placeholder="请输入出库单号" class="input" name="orderId"
				...
				style="width: 60px; height: 40px;" value="出库" id="doWare" /> <input
				type="submit" class="button border-main icon-search"
				...
				<div class="padding border-bottom">
					<ul class="search" style="padding-left: 10px;">
						<li><a class="button border-main icon-plus-square-o"
							id="doWarehouse" style="cursor: pointer">出库操作</a></li>
				...
				<table class="table table-hover text-center">
					...
					<tr>
						<td colspan="8"><div class="pagelist">
								<a
									href="<%=request.getContextPath()%>/warehouse/getTransInfoList.do?current=2&eventId=1&operatorId=<shiro:principal></shiro:principal>&keyWords=${keyWords}&startTime=${startTime}&endTime=${endTime}">首页</a>
								<a
									href="<%=request.getContextPath()%>/warehouse/getTransInfoList.do?current=${page.current-1}&eventId=2&operatorId=<shiro:principal></shiro:principal>&keyWords=${keyWords}&startTime=${startTime}&endTime=${endTime}">上一页</a>[${page.current}/${page.pageCount}]<a
									href="<%=request.getContextPath()%>/warehouse/getTransInfoList.do?current=${page.current+1}&eventId=2&operatorId=<shiro:principal></shiro:principal>&keyWords=${keyWords}&startTime=${startTime}&endTime=${endTime}">下一页</a><a
									href="<%=request.getContextPath()%>/warehouse/getTransInfoList.do?current=${page.pageCount}&eventId=2&operatorId=<shiro:principal></shiro:principal>&keyWords=${keyWords}&startTime=${startTime}&endTime=${endTime}">尾页</a><span
